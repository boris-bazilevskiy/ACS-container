...
/**
 * Active call details. This is to represent the active call details for an adhoc call.
 */
export declare interface ActiveCallDetails extends ActiveCallDetailsCommon {
    /**
...
/**
 * base class for active call details.
 */
export declare interface ActiveCallDetailsCommon {
    /**
     * The call id of the active call.
     */
    callId: string;
    /**
     * The user join time of the active call.
     */
    userJoinTime: Date;
}

/**
 * Payload for active calls updated event.
 */
export declare type ActiveCallsUpdatedEvent = (args: {
    activeCalls: (ActiveCallDetails | ActiveMeetingDetails)[];
}) => void;

/**
 * Active Call Transfer feature for CallAgent
 */
export declare interface ActiveCallTransferFeature extends CallAgentFeature {
    /**
     * Transfer to an active call
     */
    activeCallTransfer(activeCall: ActiveCallDetails | ActiveMeetingDetails, options?: ActiveCallTransferOptions): Promise<Call | TeamsCall>;
    /**
     * Get active call details
     */
    getActiveCallDetails(): Promise<(ActiveCallDetails | ActiveMeetingDetails)[] | undefined>;
    /**
     * Subscribe to activeCallsUpdated events
     */
    on(event: 'activeCallsUpdated', listener: ActiveCallsUpdatedEvent): void;
    /**
     * Subscribe to noActiveCalls events
     */
    on(event: 'noActiveCalls', listener: NoActiveCallsEvent): void;
    /**
     * Unsubscribe from activeCallsUpdated events
     */
    off(event: 'activeCallsUpdated', listener: ActiveCallsUpdatedEvent): void;
    /**
     * Unsubscribe from noActiveCalls events
     */
    off(event: 'noActiveCalls', listener: NoActiveCallsEvent): void;
}

/**
 * Options for active call transfer.
 */
export declare interface ActiveCallTransferOptions {
    /**
     * Whether to move the call to the client or have the client join the call.
     */
    isTransfer: boolean;
    /**
     * Options for joining the call.
     */
    joinCallOptions?: JoinCallOptions;
}

/**
 * Active meeting details. This is to represent the active meeting details for a interop Teams meeting.
 */
export declare interface ActiveMeetingDetails extends ActiveCallDetailsCommon {
    /**
     * Locator information for the meeting this consists of.
     * - ThreadId
     * - OrganizerId
     * - TenantId
     * - MessageId
     * It is used to identify the meeting to join.
     */
    meetingLocator: TeamsMeetingCoordinatesLocator;
}
...
export declare enum DevicePermissionAccess {
    /**
     * Permission granted
     */
    Granted = "granted",
...
/**
 * Payload for no active calls event.
 */
export declare type NoActiveCallsEvent = () => void;
